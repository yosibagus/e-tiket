                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <input required type="text" class="form-control" id="name" name="name"
                                maxlength="200" autocomplete="off" value="{{ $detail->name }}" placeholder="Masukkan nama...">
                        ...
                        <div class="col-md-6">
                            ...
                            <select name="role" id="role" required class="form-control">
                                ...
                                <option value="Petugas" {{ $detail->role == 'Petugas' ? 'selected' : '' }}>Petugas</option>
                                <option value="Mitra" {{ $detail->role == 'Mitra' ? 'selected' : '' }}>Mitra</option>
                            </select>
                        </div>
                        <div class="col-md-6 mt-3">
                            <label for="username">Username<small class="text-danger">*</small></label>
                            <input required type="text" class="form-control" id="username" name="username"
                                maxlength="10" autocomplete="off" placeholder="Masukkan username..." value="{{ $detail->username }}">
                            <div class="invalid-feedback">
                                Username tidak boleh dikosongi.
                            </div>
                        </div>
                        <div class="col-md-6 mt-3">
                            <label for="password">Password Baru<small class="text-danger">*</small></label>
