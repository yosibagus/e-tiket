                    ...
                    <div class="card bg-gra"
                        ...
                        <div class="card-body">
                            <div class="row d-flex">
                                <div class="col-md-8">
                                    <h2 class="text-bold text-weight-bolder"
                                        style="color: #000; text-shadow: #fff 1px 2px 2px; margin-bottom:2px;">

                                        U-FEST<span style="font-size: 14px;">e-ticket</span>
                                    </h2>
                                    <span class="mb-5">{{ date('F') }} {{ date('d') }},
                                        {{ date('Y') }}</span>
                                </div>
                                <div class="col-md-4">
                            ...
                            <div class="mt-4">
                                <h5 class="mb-0" style="color: #008eff">Selamat Datang, ADmin!</h5>
                            </div>
                        </div>
                    </div>
                </div>
